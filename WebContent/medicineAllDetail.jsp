                ...
                <div class="search-area-wrapper">
                        <div class="search-area container">
                                ...
                                <form id="search-form" class="search-form clearfix" method="post" action="./getDiagnoseList" autocomplete="off">
                                        <input class="search-term required" type="text" id="s" name="description" placeholder="输入药品或症状，如感冒" title="* 请输入药品或症状的关键词" />
                                        ...
                                        <div class="span8 page-content">
                                                ...
                                                <div class="row separator">
                                                   <article class="format-standard type-post hentry clearfix">
													<c:forEach var="info" items="${medicine }">					                           
													 <header class="clearfix">

                                                                <h3 class="post-title">
                                                               <font color="#f0b70c"> 药品：${info.tradename}</font>
                                                                        
                                                                </h3>
                                                      </header>
                                                      <div align="left" style="margin-left: 20px">
                                                      	<p>
                                                      	<img alt="药品" src="images/m.jpg" style="width: 100px;height: 100px;margin-left: 10px;margin-right: 10px;margin-top: 10px">
													 ...
													 <font color="#edc756">特征：</font>${info.traits}<br/>
													 <font color="#edc756">规范：</font>${info.norms}<br/>
													 <font color="#edc756">公司：</font>${info.manufacturers}<br/>
													 <font color="#edc756">规格：</font>${info.preparation}<br/>
													 <font color="#edc756">包装：</font>${info.packaging}<br/>
													 <font color="#edc756">成分：</font>${info.ingredient}<br/>
													 <font color="#edc756">用量：</font>${info.dosage}<br/>
